...
public class CustomHandlerInterceptor extends HandlerInterceptorAdapter {
    ...
    private final Logger logger = LoggerFactory.getLogger(CustomHandlerInterceptor.class);

    @Value("${SUPPORTED_API_VERSION}")
    private final String supportedApiVersion = "2.15"; //TODO fix this so it reads input from config file
